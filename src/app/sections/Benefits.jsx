...
const Benefits = () => {
  return (
    <section
      id='benefits'
      className='min-h-screen md:min-h-fit lg:min-h-screen relative overflow-hidden'
    >
      ...
      <div className='max-w-5xl py-16 space-y-5 m-auto'>
        <h2 className='p-4 text-5xl font-bold text-sky-500 leading-none'>
  ...
  return (
    <div className='card card-compact bg-transparent'>
      <div className='card-body'>
        <span className='p-4 text-4xl bg-white rounded-full w-fit h-fit text-sky-500 bg-whit shadow-lg'>
          {icon}
        </span>
